...
load("@soong_injection//cc_toolchain:constants.bzl", _generated_cc_constants = "constants")
...
generated_constants = _generated_config_constants + _generated_cc_constants
...
default_cpp_std_version = _generated_config_constants.CppStdVersion
experimental_cpp_std_version = _generated_config_constants.ExperimentalCppStdVersion
default_cpp_std_version_no_gnu = _generated_config_constants.CppStdVersion.replace("gnu", "c")
experimental_cpp_std_version_no_gnu = _generated_config_constants.ExperimentalCppStdVersion.replace("gnu", "c")
_cpp_std_versions = {
    "gnu++98": True,
    "gnu++11": True,
    "gnu++17": True,
...
default_c_std_version = _generated_config_constants.CStdVersion
experimental_c_std_version = _generated_config_constants.ExperimentalCStdVersion
default_c_std_version_no_gnu = _generated_config_constants.CStdVersion.replace("gnu", "c")
experimental_c_std_version_no_gnu = _generated_config_constants.ExperimentalCStdVersion.replace("gnu", "c")
...
arch_to_variants = {
    arches.Arm: _variant_combinations(arch_variants = _generated_config_constants.ArmArchVariantCflags, cpu_variants = _generated_config_constants.ArmCpuVariantCflags),
    arches.Arm64: _variant_combinations(arch_variants = _generated_config_constants.Arm64ArchVariantCflags, cpu_variants = _generated_config_constants.Arm64CpuVariantCflags),
    arches.X86: _variant_combinations(arch_variants = _generated_config_constants.X86ArchVariantCflags),
    arches.X86_64: _variant_combinations(arch_variants = _generated_config_constants.X86_64ArchVariantCflags),
}

def arm_extra_ldflags(variant):
    if variant.arch_variant == "armv7-a-neon":
        if variant.cpu_variant in ("cortex-a8", ""):
            return _generated_config_constants.ArmFixCortexA8LdFlags
        else:
            return _generated_config_constants.ArmNoFixCortexA8LdFlags
