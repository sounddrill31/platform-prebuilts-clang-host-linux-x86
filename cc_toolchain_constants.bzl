...
default_cpp_std_version = generated_constants.CppStdVersion
experimental_cpp_std_version = generated_constants.ExperimentalCppStdVersion
default_cpp_std_version_no_gnu = generated_constants.CppStdVersion.replace("gnu", "c")
experimental_cpp_std_version_no_gnu = generated_constants.ExperimentalCppStdVersion.replace("gnu", "c")
_cpp_std_versions = {
    "gnu++98": True,
    "gnu++11": True,
    "gnu++17": True,
...
default_c_std_version = generated_constants.CStdVersion
experimental_c_std_version = generated_constants.ExperimentalCStdVersion
default_c_std_version_no_gnu = generated_constants.CStdVersion.replace("gnu", "c")
experimental_c_std_version_no_gnu = generated_constants.ExperimentalCStdVersion.replace("gnu", "c")
...
arch_to_variants = {
    arches.Arm: _variant_combinations(arch_variants = generated_constants.ArmArchVariantCflags, cpu_variants = generated_constants.ArmCpuVariantCflags),
    arches.Arm64: _variant_combinations(arch_variants = generated_constants.Arm64ArchVariantCflags, cpu_variants = generated_constants.Arm64CpuVariantCflags),
    arches.X86: _variant_combinations(arch_variants = generated_constants.X86ArchVariantCflags),
    arches.X86_64: _variant_combinations(arch_variants = generated_constants.X86_64ArchVariantCflags),
}

def arm_extra_ldflags(variant):
    if variant.arch_variant == "armv7-a-neon":
        if variant.cpu_variant in ("cortex-a8", ""):
            return generated_constants.ArmFixCortexA8LdFlags
        else:
            return generated_constants.ArmNoFixCortexA8LdFlags
