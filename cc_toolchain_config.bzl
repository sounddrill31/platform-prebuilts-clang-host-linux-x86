...
def _cc_toolchain_config_impl(ctx):
    ...
    features = _link_crtbegin(ctx) or []
...
_cc_toolchain_config = rule(
    ...
    attrs = {
        ...
        "shared_library_crtbegin": attr.label(allow_single_file = True),
        "shared_library_crtend": attr.label(allow_single_file = True),
