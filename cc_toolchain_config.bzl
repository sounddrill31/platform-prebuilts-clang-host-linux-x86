...
def _cc_toolchain_config_impl(ctx):
    ...
    always_linker_flag_feature = _linker_flag_feature(
        "always_linker_flags",
    ...
    features = compiler_flag_features + _rpath_features() + [always_linker_flag_feature, linker_flag_feature, toolchain_include_directories_feature, system_libraries_feature]
