...
def _cc_toolchain_config_impl(ctx):
    ...
    # FIXME: This is currently wrong, because the list contains relative dirs to this package, not from the workspace root.
    builtin_include_dirs.extend(constants.GLOBAL_INCLUDE_DIRS_COPTS_ONLY_USED_FOR_SOONG_COMPATIBILITY_DO_NOT_ADD_MORE)
