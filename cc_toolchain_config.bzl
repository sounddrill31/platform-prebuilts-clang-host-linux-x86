...
def is_target_os_device(ctx):
    return ctx.attr.target_os == "android"
...
def _cc_toolchain_config_impl(ctx):
    ...
    return cc_common.create_cc_toolchain_config_info(
        ...
        host_system_name = "__toolchain_host__",
        target_system_name = "__toolchain_target_system__",
        target_libc = "__toolchain_target_libc__",
        compiler = "__toolchain_target_compiler__",
