...
def _get_clang(clang_version):
    return Label("//prebuilts/clang/host/linux-x86/kleaf/parent/clang-{}:bin/clang".format(clang_version))

def _get_clang_plus_plus(clang_version):
    return Label("//prebuilts/clang/host/linux-x86/kleaf/parent/clang-{}:bin/clang++".format(clang_version))

def _get_strip(clang_version):
    return Label("//prebuilts/clang/host/linux-x86/kleaf/parent/clang-{}:bin/llvm-strip".format(clang_version))

def _get_ar(clang_version):
    return Label("//prebuilts/clang/host/linux-x86/kleaf/parent/clang-{}:bin/llvm-ar".format(clang_version))
