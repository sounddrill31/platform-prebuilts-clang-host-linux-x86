...
def _env_based_common_global_cflags(ctx):
    ...
    if clang_debug_env_value == "":
        flags.extent(["-g"])
    else if clang_debug_env_value == "debug_level_g":
        flags.extent(["-g"])
    else if clang_debug_env_value == "debug_level_0":
        flags.extent(["-g0"])
    else if clang_debug_env_value == "debug_level_1":
        flags.extent(["-g1"])
    else if clang_debug_env_value == "debug_level_2":
        flags.extent(["-g2"])
    else if clang_debug_env_value == "debug_level_3":
        flags.extent(["-g3"])
