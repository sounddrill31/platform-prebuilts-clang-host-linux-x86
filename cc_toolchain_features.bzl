...
def _get_legacy_features_begin():
    features = [
        ...
        # ---
        #
        # http://google3/third_party/bazel/src/main/java/com/google/devtools/build/lib/rules/cpp/CppActionConfigs.java;l=98;rcl=399031310
        feature(
        ...
        # http://google3/third_party/bazel/src/main/java/com/google/devtools/build/lib/rules/cpp/CppActionConfigs.java;l=147;rcl=399031310
        feature(
            name = "pic",
            enabled = True,
            flag_sets = [
        ...
        # http://google3/third_party/bazel/src/main/java/com/google/devtools/build/lib/rules/cpp/CppActionConfigs.java;l=186;rcl=399031310
        feature(
        ...
        # http://google3/third_party/bazel/src/main/java/com/google/devtools/build/lib/rules/cpp/CppActionConfigs.java;l=207;rcl=399031310
        feature(
            name = "includes",
            enabled = True,
            flag_sets = [
