    ...
    features.append(feature(
        ...
        flag_sets = [
            flag_set(
                ...
                with_features = [
                    with_feature_set(not_features = ["pie"]),
                ],
            ),
        ],
    ))
    ...
    features.append(feature(
        ...
        flag_sets = [
            flag_set(
                ...
                with_features = [
                    with_feature_set(not_features = ["pic"]),
                ],
            ),
        ],
    ))
    ...
    disable_pack_relocations_feature = feature(
        ...
        flag_sets = [
            flag_set(
                ...
                with_features = [
                    with_feature_set(not_features = ["pack_dynamic_relocations"]),
                ],
            ),
        ],
        enabled = False,
...
def _undefined_symbols_feature():
    return _linker_flag_feature("undefined_symbols", flags = ["-Wl,--no-undefined"], enabled = True)
...
_library_linking_actions = [_actions.cpp_link_dynamic_library, _actions.cpp_link_nodeps_dynamic_library]

def _library_linker_flag_feature(name, flags = [], enabled = True):
    return _flag_feature(name, actions = _library_linking_actions, flags = flags, enabled = enabled)
...
def _static_binary_flags(os_is_device):
    linker_flags = []
    if os_is_device:
        linker_flags.extend(_flags.bionic_static_executable_linker_flags)
    return linker_flags

def _shared_binary_flags(os_is_device):
    linker_flags = []
    if os_is_device:
...
def get_features(
    ...
    features = [
        ...
        _binary_linker_flag_feature("dynamic_executable", flags = _shared_binary_flags(os_is_device)),
        ...
        _binary_linker_flag_feature("static_executable", flags = _static_binary_flags(os_is_device), enabled = False),
