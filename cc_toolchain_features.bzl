...
def _get_legacy_features_begin():
    features = [
        ...
        #
        # ------------------------
        # https://cs.opensource.google/bazel/bazel/+/master:src/main/java/com/google/devtools/build/lib/rules/cpp/CppActionConfigs.java;l=367;drc=6d03a2ecf25ad596446c296ef1e881b60c379812
        feature(
            name = "autofdo",
            flag_sets = [
                flag_set(
