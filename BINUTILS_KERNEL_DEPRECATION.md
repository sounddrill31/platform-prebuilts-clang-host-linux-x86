As of Android S, this work is fully complete (except for ARCH=arm on
android-4.19-stable). ie. build commands should be one of:

```sh
# arm64
$ ARCH=arm64 CROSS_COMPILE_COMPAT=arm-linux-gnueabi- make LLVM=1

# arm
$ ARCH=arm make LLVM=1
$ ARCH=arm CROSS_COMPILE=arm-linux-gnueabi- make LLVM=1 # android-4.19-stable
