...
def _test_exclude_ubsan_rt():
    ...
    test_cases = [
        ...
        },
        {
            "os": "android",
            "arch": "arm64",
            "flag": "-Wl,--exclude-libs=libclang_rt.ubsan_minimal-arm64-android.a",
        },
        {
            "os": "android",
            "arch": "x86",
            "flag": "-Wl,--exclude-libs=libclang_rt.ubsan_minimal-x86-android.a",
        },
        {
            "os": "android",
            "arch": "x86_64",
        ...
        },
        {
            "os": "linux",
            "arch": "x86",
            "flag": "-Wl,--exclude-libs=libclang_rt.ubsan_minimal-x86.a",
        },
        {
            "os": "linux",
            "arch": "x86_64",
