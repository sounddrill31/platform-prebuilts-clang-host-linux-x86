...
// some LLVM-related builds, on the other hand, the Darwin filegroups are
// defined, but the build uses clang-dev instead of clang-rNNNNNN, but clang-dev
// only exists for linux-x86, not darwin-x86.
