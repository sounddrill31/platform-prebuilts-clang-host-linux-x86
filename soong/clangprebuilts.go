...
func llvmDarwinFileGroup(ctx android.LoadHookContext) {
	...
	// TODO: This seems like the wrong place to be calling ExistentPathForSource?
	// If the darwin-x86 directory isn't checked out, then the filegroups
	// themselves won't be defined, so this code doesn't run AFAIK.
